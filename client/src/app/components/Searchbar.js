...
import { Input,Search, Grid, Header } from 'semantic-ui-react';
  ...
  mapItem = (items) => {
    ...
    for(var i=0;i<items.result.length;i++){
        final.push({
          ...
          description: items.result[i].description.length>200 ? items.result[i].description.substring(0,200)+"....": items.result[i].description,
